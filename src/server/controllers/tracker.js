...
// select phone from users u inner join orders o on u.id=o.user_id where o.id=4;
select.selectUserBasedOnOrderId(cb.rows[0].orderid , cb1=>{
  ...
  client.messages
    .create({ from: '+17192203059', body: `your tracking number is: ${trakerNumber}`, to: targetPhone })
